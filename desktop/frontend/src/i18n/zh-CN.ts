...
export const zhCN: Dict = {
  ...
  "sandbox.allowNetworkHint": "当沙盒设置为工作区写入时允许网络访问",
  "sandbox.notProvisioned": "沙盒尚未设置。",
  "sandbox.setup": "设置沙盒",
  "sandbox.settingUp": "正在设置…",
  "sandbox.passwordsMismatch":
    "沙盒用户已存在，但其密码与当前配置不匹配，沙盒命令可能无法以受限身份启动。请重新设置沙盒以重建沙盒用户。",
  "sandbox.passwordsMismatchHint":
    "重新设置以重建沙盒用户。",
  "sandbox.setupFailed": "无法启动沙盒设置。",
  "sandbox.errSave": "保存沙盒设置失败。",
  "sandbox.loadFailed": "无法加载沙盒设置。",
  "sandbox.unsupported": "当前平台暂不支持沙盒。",
