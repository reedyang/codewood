...
export const zhCN: Dict = {
  ...
  "settings.page.console": "控制台",
  "settings.console.font": "字体",
  "settings.console.fontPlaceholder": "例如 Cascadia Mono、Consolas",
  "settings.console.fontHint": "内嵌控制台使用的字体（留空则使用默认等宽字体）。",
  "settings.console.buffer": "缓冲行数",
  "settings.console.bufferHint": "每个控制台标签保留的回滚行数（100-100000）。",
  "console.new": "新建控制台",
  "console.new.powershell": "PowerShell",
  "console.new.cmd": "命令提示符",
  "console.new.gitbash": "Git Bash",
  "console.options": "控制台选项…",
  "console.tab.close": "关闭控制台",
  "console.hide": "隐藏控制台",
  "console.empty": "尚未打开控制台。点击 + 按钮新建一个。",
