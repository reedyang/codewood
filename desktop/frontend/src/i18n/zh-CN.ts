...
export const zhCN: Dict = {
  ...
  "tool.label.background_task_kill": "结束后台任务",
  "tool.label.background_task_status": "后台任务状态",
  "tool.label.wait": "等待",
  ...
  "sandbox.levelHint": "选择 Code Wood 运行命令时的操作范围",
  "sandbox.readOnly": "只读 — 可以读取文件，但不能编辑",
  "sandbox.workspaceWrite": "工作区写入 — 只能编辑当前工作区内的文件",
  "sandbox.fullAccess": "完全访问 — 可以编辑工作区以外的文件",
  "sandbox.fullAccessWarning":
    "⚠ 完全访问会以你的完整用户权限运行命令 — 仅在信任当前任务时使用。",
  "sandbox.allowNetwork": "允许网络访问",
  "sandbox.allowNetworkHint": "当沙箱设置为工作区写入时允许网络访问",
  "sandbox.notProvisioned": "沙箱尚未设置。",
  "sandbox.setup": "设置沙箱",
  "sandbox.settingUp": "正在设置…",
  "sandbox.passwordsMismatch":
    "沙箱用户已存在，但其密码与当前配置不匹配，沙箱命令可能无法以受限身份启动。请重新设置沙箱以重建沙箱用户。",
  "sandbox.passwordsMismatchHint":
    "重新设置以重建沙箱用户。",
  "sandbox.setupFailed": "无法启动沙箱设置。",
  "sandbox.errSave": "保存沙箱设置失败。",
  ...
  "models.search": "搜索模型",
  "models.searchPlaceholder": "搜索模型（支持 * 通配符）",
...
"noModel.title": "请先配置模型",
  ...
  "tools.hint": "被关闭的工具不会出现在暴露给模型的工具列表中。",
  "tools.compactMode": "精简模式",
  "tools.compactModeHint": "开启后关闭所有可选工具，可在下方按需单独开启；关闭后开启全部可选工具且不可单独关闭。自定义的开关设置会被保留，下次开启精简模式时恢复。",
  "tools.lockedByMode": "精简模式关闭时可选工具始终开启",
  "tools.errCompact": "切换精简模式失败。",
  "tools.emptyHint": "没有可用的内建工具。",
  "tools.groupCore": "核心（始终开启）",
  "tools.groupOptional": "可选",
  "tools.enabled": "已启用",
  "tools.enabledCount": "已启用",
  "tools.locked": "不可关闭",
  "tools.lockedTitle": "该工具为核心工具，无法关闭。",
  "tools.errToggle": "切换工具状态失败。",
  "dashboard.input": "输入",
  "dashboard.output": "输出",
