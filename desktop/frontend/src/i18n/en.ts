...
export const en: Dict = {
  ...
  "retry.countdown": "{label} — retry #{n} in {seconds}s",
  "retry.httpError": "HTTP {code}",
  ...
  "tool.label.console_send": "Send console input",
  "tool.label.console_wait": "Wait for console output",
  "tool.label.console_interrupt": "Interrupt console (Ctrl+C)",
  "tool.label.console_resize": "Resize console",
  "tool.label.background_task_kill": "Kill background task",
  "tool.label.background_task_status": "Background task status",
  "tool.label.wait": "Wait",
  ...
  "security.shellScripts": "Shell Scripts",
  "security.noScripts": "No shell scripts in the allowlist.",
  "security.scriptPathPlaceholder": "Script path (absolute)...",
  "security.scriptHashPlaceholder": "Hash (optional)...",
  "security.shellExeTokens": "Executable Tokens",
  "security.noExeTokens": "No executable tokens in the allowlist.",
  "security.exeTokenPlaceholder": "Executable name or path...",
  "security.exeTokenHint": "Use * as a wildcard. /foo/bar/* matches all files in /foo/bar.",
  ...
  "models.searchPlaceholder": "Search models (supports * wildcard)",
  "models.noSearchResults": "No matching models.",
  ...
  "models.contextWindowPlaceholder": "e.g. 128k (= 131072)",
  ...
  "fileChange.reapply": "Reapply",
  "fileChange.undoFail": "Undo Failed",
  "fileChange.reapplyFail": "Reapply Failed",
  "fileChange.undone": "Undone",
  ...
  "tools.hint": "Disabled tools are removed from the tool schema exposed to the model.",
  "tools.compactMode": "Compact mode",
  "tools.compactModeHint": "When on, all optional tools are turned off and can be re-enabled individually. Turning it off re-enables every optional tool; your custom toggles are kept and restored the next time Compact mode is turned on.",
  "tools.lockedByMode": "Optional tools are always on while Compact mode is off",
  "tools.errCompact": "Failed to toggle Compact mode.",
  "tools.emptyHint": "No built-in tools available.",
  "tools.groupCore": "Core (always on)",
  "tools.groupOptional": "Optional",
  "tools.enabled": "Enabled",
  "tools.enabledCount": "enabled",
  "tools.locked": "Locked",
  "tools.lockedTitle": "This tool is essential and cannot be disabled.",
  "tools.errToggle": "Failed to toggle tool.",
  "dashboard.input": "INPUT",
  "dashboard.output": "OUTPUT",
  "dashboard.context": "CONTEXT",
  "dashboard.contextWindow": "Context window",
  "dashboard.contextUsed": "Used",
  "dashboard.contextPercent": "Usage",
  "dashboard.contextEmpty": "No usage data yet",
  "dashboard.part.system": "System prompt",
  "dashboard.part.skills": "Skills list",
  "dashboard.part.agentsMd": "AGENTS.md",
  "dashboard.part.userPreferences": "Preferences",
  "dashboard.part.tools": "Tools",
  "dashboard.part.subagents": "Sub agents",
  "dashboard.part.mcp": "MCP servers",
  "dashboard.part.history": "History",
