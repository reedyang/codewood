...
export const en: Dict = {
  ...
  "settings.page.console": "Console",
  "settings.console.font": "Font",
  "settings.console.fontPlaceholder": "e.g. Cascadia Mono, Consolas",
  "settings.console.fontHint":
    "Font family for the embedded console (leave empty for the default monospace).",
  "settings.console.buffer": "Buffer lines",
  "settings.console.bufferHint":
    "How many lines of scrollback each console tab keeps (100-100000).",
  "console.new": "New console",
  ...
  "console.tab.close": "Close console",
