...
export class ApiClient {
  ...
  async fetchIndexStatus(): Promise<IndexStatus> {
    ...
    if (!res.ok) {
      return { hidden: true, files_total: 0, workspace_name: "", is_default_workspace: true, refresh_phase: "", refresh_progress_total: 0, refresh_progress_done: 0, refresh_progress_percent: 0, workspaces: [] };
    }
