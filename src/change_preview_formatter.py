...
class ChangePreviewFormatter:
    ...
    def format_side_by_side(
        ...
        for mark_pair, left_segment, right_segment in wrapped_rows:
            left_rendered = ChangePreviewFormatter._pad_to_width(left_segment, left_col_width)
            right_rendered = right_segment
            if "-" in mark_pair:
                left_rendered = f"{ChangePreviewFormatter.ANSI_BG_RED}{left_rendered}{ChangePreviewFormatter.ANSI_RESET}"
            if "+" in mark_pair:
                right_rendered = f"{ChangePreviewFormatter.ANSI_BG_GREEN}{right_rendered}{ChangePreviewFormatter.ANSI_RESET}"
