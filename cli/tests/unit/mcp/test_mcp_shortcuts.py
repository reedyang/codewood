...
class McpShortcutCommandTests(unittest.TestCase):
    ...
    def test_parse_all_valid_mcp_shortcuts(self):
        cases = {
            ...
            "mcp list-tools playwright": ("mcp_list_tools", {"server": "playwright", "use_cache": False}),
            "mcp list-resources playwright": ("mcp_list_resources", {"server": "playwright", "use_cache": False}),
