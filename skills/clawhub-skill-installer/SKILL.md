...
description: Search skills from ClawHub and install a selected skill with explicit CLI confirmation. Use this whenever the user asks to browse, find, or install skills from clawhub.ai, especially for "search and install a skill".
---
